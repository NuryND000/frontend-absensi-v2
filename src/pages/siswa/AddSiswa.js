...
return ( <section className="hero is-small"> <div className="columns is-mobile is-centered"> <div className="column is-half"> <form onSubmit={saveUser}> <div className="field is-horizontal"> <div className="field-body"> <div className="field"> <label className="label">{Role === "siswa" ? "NISN" : "NIP"}</label> <div className="control">
<input
type="number"
className="input"
value={username}
...
placeholder="123"
required
/> </div> </div> <div className="field"> <label className="label">Nama</label> <div className="control">
<input
type="text"
className="input"
value={name}
